"""
This is a script for migrating existing datasets
to have the default exteral access value.
...
def update_datasets(url, api_key):
    ...
    params = {'q': '-external_access_level:[* TO *]', 'include_private': True, 'rows': 1000}
    ...
    if count == 0:
        print('No datasets without an existing "external_access_level" value were found.\n'
    ...
    for dataset in datasets:
        ...
        if not result['success']:
            ...
            if not result['success']:
                ...
                continue
        assert result['result']['external_access_level'] == 'not_available'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Migrate existent datasets to have the default external access value')
